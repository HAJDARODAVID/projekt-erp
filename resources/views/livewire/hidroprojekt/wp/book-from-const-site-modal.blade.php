<div>
    <button type="submit" class="btn btn-danger" wire:click='modalBtn(1)'><i class="bi bi-building-dash"></i><i class="bi bi-arrow-down"></i></button>

    <div class="modal modal-lg" id="bookToStorageModal" style="display:  @if ($activeModal) block @else none @endif">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Knjiženje materijala sa stanja gradilišta</h5>
                </div>
